...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/easyquery-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11251&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/easyquery-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `easyquery` can be installed with:

```
conda install easyquery
```

It is possible to list all of the versions of `easyquery` available on your platform with:
